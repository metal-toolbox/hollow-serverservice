...
var (
	componentFirmwareVersionDBTypes = map[string]string{`ID`: `uuid`, `Component`: `string`, `Vendor`: `string`, `Model`: `string`, `Filename`: `string`, `Version`: `string`, `Utility`: `string`, `Sha`: `string`, `UpstreamURL`: `string`, `S3URL`: `string`}
	_                               = bytes.MinRead
)
